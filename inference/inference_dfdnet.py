...
if __name__ == '__main__':
    ...
    result_root = args.results_root#f'results/DFDNet/{os.path.basename(args.test_path)}'
    ...
    save_final_root = result_root#os.path.join(result_root, 'final_results')

    face_helper = FaceRestorationHelper(args.upscale_factor, face_size=512)

    print(args.test_path)
    print(os.path.join(args.test_path, '*[jp][pn]g'))
    print(glob.glob(os.path.join(args.test_path, '*.[jp][pn]g')))
